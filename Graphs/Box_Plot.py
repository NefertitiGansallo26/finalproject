...
# Bin Literacy Rate into categories
bins =[0,30,50,75,90,100] # Define intervals for literacy rate
labels = ['0-30%','31-50%', '51-75%', '76-90%', '91-100%']
data['Literacy_Rate_Category'] = pd.cut(data['Literacy_Rate'], bins=bins, labels=labels)

# Box Plot
plt.figure(figsize=(13, 7))
sns.boxplot(
    data=data,
    x='Literacy_Rate_Category',
    y='GDP_Per_Capita',
    hue='Continent',
    palette='Set1',
    width=0.8
...
# Plot Customizations
plt.title('GDP per Capita Distribution by Literacy Rate Category Across Continents', fontsize=16)
plt.xlabel('Literacy Rate Categories (%)', fontsize=14)
